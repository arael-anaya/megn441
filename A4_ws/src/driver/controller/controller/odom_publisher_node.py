...
class Controller(Node):
    ...
    def cal_odom_fun(self):
        while True:
            ...
            # If velocity is zero, it indicates that the error of the encoder is relatively small, and the data from the encoder is considered more reliable
            # If velocity is non-zero, the data from the IMU is considered more reliable, taking into account the sliding error that the encoder may introduce during motion
